            ...
            <ul class="sidebar-menu">
                ...
                <li class="active treeview">
                    ...
                    <ul class="treeview-menu">
                        <li class="active"><a href="index.html"><i class="fa fa-circle-o"></i> Ver Tareas</a></li>
                        <li><a href="index2.html"><i class="fa fa-circle-o"></i>Nueva Tarea</a></li>
                    </ul>
                </li>
                <li>
                ...
                <div class="col-md-3">
                    <div class="box box-solid">
                        <div class="box-header with-border">
                            <h4 class="box-title">Arrastrar Tareas</h4>
                        </div>
                        <div class="box-body">
                            <!-- the events -->
                            <div id="external-events">
                                <div class="external-event bg-green">Ejemplo</div>
                                <div class="external-event bg-yellow">Prueba de tarea</div>
                                <div class="external-event bg-aqua">Terminar eventos</div>
                                <div class="checkbox">
                    ...
                    <div class="box box-solid">
                        <div class="box-header with-border">
                            <h3 class="box-title">Crear una nueva tarea</h3>
                        </div>
                        <div class="box-body">
                            ...
                            <div class="input-group">
                                <input id="new-event" type="text" class="form-control" placeholder="Nombre de tu tarea">
                                <div class="input-group-btn">
                                    <button id="add-new-event" type="button" class="btn btn-primary btn-flat">Agregar
                                    </button>
                                </div><!-- /btn-group -->
                            </div><!-- /input-group -->
                        </div>
    ...
    $(function () {
        ...
        function ini_events(ele) {
            ele.each(function () {
                ...
                // no es necesario un inicio y fin
                var eventObject = {
                    title: $.trim($(this).text()) // utilizar el texto del evento como el título
                };

                // almacenar el elemento
                $(this).data('eventObject', eventObject);

                // arrastrar los eventos al calendario
                $(this).draggable({
                    zIndex: 1070,
                    revert: true,
                    revertDuration: 0  //  posición original tras ser arrastrado
                });
        ...
        /* iniciar el calendario
         -----------------------------------------------------------------*/
        //Fechas para los eventos (dummy data)
        var date = new Date();
        var d = date.getDate(),
                m = date.getMonth(),
                y = date.getFullYear();
        $('#calendar').fullCalendar({
            ...
            editable: true,
            droppable: true, // permite arrastras elementos al calendario!!!
            drop: function (date, allDay) { // llamo a la función si un elemento es arrastrado

                // muestro los elementos almacenados
                ...
                // si se activa el ckeck de eliminar tras arrastrar
                if ($('#drop-remove').is(':checked')) {
                    // eliminar el elemento tras el arraste
                    $(this).remove();
                }
        ...
        $("#color-chooser > li > a").click(function (e) {
            ...
            //Agregar el color del evento al botón
            $('#add-new-event').css({"background-color": currColor, "border-color": currColor});
        });
        $("#add-new-event").click(function (e) {
            e.preventDefault();
            //tomar valor y no dejarlo en nulo
