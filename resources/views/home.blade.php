...
<div class="col-md-5">
    <h3>Bienvenidos a nuestra Red Social</h3>
</div>
<div class="col-md-6">
    <div class="login-box">
        ...
        <div class="login-box-body">
            ...
            <form class="form-vertical" role="form" method="post" action=" {{
              route('auth.signin') }} ">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-4">
                        <button type="submit" class="btn btn-primary btn-block btn-flat"><i class="fa fa-power-off"
                                                                                            aria-hidden="true"></i>
                            Ingresar
                        </button>
                    </div><!-- /.col -->
            ...
            <a href="{{route('auth.signup')}}">Registrarme</a><br>
